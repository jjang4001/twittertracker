...
func main() {
	...
	consumerKey := os.Getenv(common.ConsumerKey)
	consumerSecret := os.Getenv(common.ConsumerSecret)
	accessKey := os.Getenv(common.AccessKey)
	accessSecret := os.Getenv(common.AccessSecret)
	setupRedisQueue()
